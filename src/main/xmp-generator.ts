        ...
        const correctionLis = masks
          .map((m: any, i: number) => {
            ...
            const adjAttrs = [
              ...
              attrIf('LocalWhites2012', f3(normalizeLocal('whites', adj.whites))),
              attrIf('LocalBlacks2012', f3(normalizeLocal('blacks', adj.blacks))),
              attrIf('LocalClarity2012', f3(normalizeLocal('clarity', adj.clarity))),
              attrIf('LocalDehaze', f3(normalizeLocal('dehaze', adj.dehaze))),
              attrIf('LocalLuminanceNoise', 0),
              attrIf('LocalMoire', 0),
              attrIf('LocalDefringe', 0),
              attrIf('LocalTexture', f3(normalizeLocal('texture', adj.texture))),
              attrIf('LocalSaturation', f3(normalizeLocal('saturation', adj.saturation))),
              attrIf('LocalGrain', 0),
