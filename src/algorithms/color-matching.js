...
class ColorMatcher {
     ...
     */
    static matchHistogram(sourceHist, targetHist) {
     ...
     */
    static calculateColorCorrection(sourceAvg, targetAvg) {
        ...
        const offset = { r: 0, g: 0, b: 0 };
        return { gain, offset };
    }
    /**
     * Calculate color temperature from RGB values
     */
    static calculateColorTemperature(rgb) {
     ...
     */
    static analyzeColorBalance(dominantColors) {
...
exports.ColorMatcher = ColorMatcher;
